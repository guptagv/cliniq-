     ...
     return (
       <main className="min-h-screen bg-white">
         ...
         <nav className="border-b px-6 py-4 flex justify-between items-center max-w-6xl mx-auto">
           ...
           <a href="/upload" className="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
             Get Started
           </a>
         </nav>
         ...
         <section className="max-w-4xl mx-auto px-6 py-20 text-center">
           ...
           <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
             Upload clinical trial protocols, SAPs, or regulatory documents.
             Ask questions in plain English. Get AI-powered answers with
             exact page and section references.
           </p>
           <a href="/upload" className="bg-blue-600 text-white px-8 py-4 rounded-lg text-lg hover:bg-blue-700 transition">
           ...
           <div className="max-w-5xl mx-auto px-6">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="text-center p-6">
                 ...
                 <p className="text-gray-600">Drop your clinical trial protocol or regulatory document (PDF)</p>
               </div>
               <div className="text-center p-6">
                 <div className="text-3xl mb-4">💬</div>
                 <h4 className="font-semibold text-lg mb-2">2. Ask</h4>
                 <p className="text-gray-600">Type your question in plain English — like asking a colleague</p>
               </div>
               <div className="text-center p-6">
                 <div className="text-3xl mb-4">🎯</div>
                 <h4 className="font-semibold text-lg mb-2">3. Get Cited Answers</h4>
                 <p className="text-gray-600">AI-powered answers with exact page numbers and section references</p>
               </div>
             </div>
           </div>
         </section>
         ...
         <section className="py-16">
           <div className="max-w-4xl mx-auto px-6 text-center">
             <h3 className="text-2xl font-bold mb-8">Built for Pharma Professionals</h3>
